...
import { Customer } from 'electron/entities/customer';
...
export class CartComponent implements OnInit {
  ...
  checkCustomer() {
    ...
    this.dialogService.checkCustomer(AddUpdateCustomerComponent,data).subscribe(customer => {
      console.log("received cart customer", customer);
